...
def get_training_transform():
    train_transform = [
        ...
        albu.CoarseDropout(fill_value=0, p=0.25),
        albu.Normalize(),
    ]
...
class DeepGlobeDataset(Dataset):
    def __init__(self, data_root='data/potsdam/test', mode='val', img_dir='images_256', mask_dir='masks_256',
...
if __name__ == '__main__':
    ...
    t = SmartCropV1(crop_size=192, max_ratio=0.75, ignore_index=len(CLASSES), nopad=False)
    out1, out2 = t(img, img)
    print(out1.size)
    print(out2.size)
